...
- [ ] **No regression on macOS** — I have run `npm test`, `npm run typecheck`, `npm run lint`, `npm run build`, and (for UI/security-sensitive changes) `npm run real-app-audit` and `npm run verify-hardening` on macOS.
