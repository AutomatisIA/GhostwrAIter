 ...
 * mais `claude --print --output-format json` et `gemini --json` encadrent la
 * reponse du modele dans leur PROPRE enveloppe : le contrat de la skill s y
 * trouve sous forme de chaine, dans `result` pour Claude et `response` pour
 * Gemini. Sans deballage, `JSON.parse` reussit sur l enveloppe et le contrat
 * parait invalide, ce qui rendait les moteurs autres que Codex inutilisables.
 *
